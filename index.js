...
const quiz = await inquirer.prompt([
    {
        name: "question_1",
        type: "list",
        message: "Q1:What is correct command to install tsconfig.json file in typscript?",
    ...
    },
    {
        name: "question_4",
        type: "list",
        message: "Q4:Which method of Inquirer.js is used to start the prompt interface and receive user in?",
        choices: ["start()", "prompt()", "init()", "run()"],
    },
    {
        name: "question_5",
        type: "list",
        message: "Q5:Which of the following command is used to install the types of inquirer?",
        choices: [
            "tsc --init",
            "npm i @types/node -v",
